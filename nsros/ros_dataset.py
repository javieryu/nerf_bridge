...
# has no imports from nerf_bridge package
...
class ROSDepthDataset(ROSDataset):
    ...
    def __init__(
        ...
        # self.depth_tensor=self.depth_tensor.reshape(self.image_height, self.image_width)
    ...
    def __getitem__(self, idx: int):
        ...
        data = {"depth_idx": idx, "depth": self.depth_tensor[idx]}
        return data
